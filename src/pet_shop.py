...
# add or remove cash tasks 4 & 5

def add_or_remove_cash(pet_shop, money):
    pet_shop["admin"]["total_cash"] += money

# task 6  return number of sold pets

def get_pets_sold(pet_shop):
    return pet_shop["admin"]["pets_sold"]

# task 7 increase the number of sold pets

def  increase_pets_sold(pet_shop, add_number ):
     pet_shop["admin"]["pets_sold"] = add_number


# task 8 count (LEN) the number of pets for a stock count
def get_stock_count(pet_shop):
    
    return len(pet_shop["pets"])
    

# task 9 return the number of a specific breed.
# task 10 return none if breed doesn't exits
...
# task 16 get count of pets for a customer

def get_customer_pet_count (customer_pets):

    return len(customer_pets["pets"])

#task 17 add a pet to a customer.
